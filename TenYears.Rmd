...
```{r}
setwd("C:/Users/chrobin/OneDrive - The University of Liverpool/Projects/FP_10years")
getwd()
```
...
# Add additional Census variables for context
```{r}
...
LA_finaldataset$clustering5 <- as.character(LA_finaldataset$clustering5)
str(LA_finaldataset)
```
